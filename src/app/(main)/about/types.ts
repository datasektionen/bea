...
export type RolesInfo = Record<
  Role,
  { slug: Role; name: string; description?: React.ReactNode }
>;
export const rolesInfo: RolesInfo = {
  ...
  stadskrii: {
    ...
    name: "Städskrii",
    description:
      "Städskrii ansvarar för måndagsstäden och anordnar städfesten i maj.",
  },
  arkadmicke: {
    slug: "arkadmicke",
    name: "Arkadmicke",
    description:
      "Arkadmicke ansvarar för förvaltning och uppgradering av drifvarkaden i META.",
  },
  flippermicke: {
    slug: "flippermicke",
    name: "Flippermicke",
    description:
      "Flippermicke ansvarar för förvaltning och uppgradering av flipperspelet i META.",
  },
  mkdir: {
    slug: "mkdir",
    name: "Mkdir",
    description:
      "MKDIR (Master of Kitchen inventory, DevIces and Resources) ansvarar över köket så att det är i ordning och trevligt att använda.",
  },
  laskkylsansvarig: {
  ...
  //   name: "Mums",
  //   description:
  //     "Mums (Master Uf Magnifika Sötsaker) ansvarar för att köpa in fika till fredagsmötet.",
  // },
  matrix: {
    slug: "matrix",
    name: "Matrix",
